...
def build_colors(c):
    ...
    base_colors = ["#43B9D8", "#02B5FC75", "#02B5FC25", "#02B5FC15", "#E96401", "#E9640115"]

    features = {
        "orange": ["#E96401", "#E9640175", "#E9640125", "#E9640115", "#F9C449", "#F9C44915"],
        "green ": ["#19FC8E", "#19FC8E75", "#19FC8E25", "#19FC8E15", "#43B9D8", "#43B9D815"],
        "purple": ["#AE81FF", "#AE81FF75", "#AE81FF25", "#AE81FF15", "#43B9D8", "#43B9D815"],
        "yellow": ["#F9C449", "#F9C44975", "#F9C44925", "#F9C44915", "#E96401", "#E9640115"],
